...
export const parts: Part[] = [
  { id: 'top-case', name: 'Top case', system: 'enclosure', description: 'The main structural shell.', detail: 'Supports the keyboard, trackpad, and internal assembly. Shown in Space Black; the 2026 model also comes in Silver. The whole closed notebook measures 31.26 × 22.12 × 1.55 cm.', material: 'Aluminum', location: 'Main base, surrounding the keyboard and palm rest.' },
